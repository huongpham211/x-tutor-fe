...
class Bodyupdatecard extends Component {
        ...
        <div className="container">
          <div className="edit-info1 row">
            <div className="col-md-3 left">
              ...
              <div className="down">
                <Link to={`/account_setting/${this.state.iduser}`} className="edit justify-content-center">
                  <i className="fas fa-user" />
                  <h5>Account Settings</h5>
                  <i className="fas fa-chevron-right" />
                </Link>
                <Link to={`/change_password/${this.state.iduser}`} className="change justify-content-center">
                  <i className="fas fa-lock" />
                  <h5>Change Password</h5>
                  <i className="fas fa-chevron-right" />
                </Link>
                <Link to={`/payment_info/${this.state.iduser}`} className="payment justify-content-center">
