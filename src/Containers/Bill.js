                ...
                return axios
                    ...
                    .then((response) => {
                        ...
                        this.setState({
                            ...
                            address: response.data.userFound.address,
            ...
            <div>
                ...
                <div className="bill" ref="{ref}">
                    <div className="top">
                        ...
                        <div className="col-md-5 billto">
                            <h4>Bill to</h4>
                            <h3>{this.state.name}</h3>
                            <h5><i className="fas fa-map-marker-alt" />{this.state.address}</h5>
                            <h5><i className="fas fa-envelope" />{this.state.email}</h5>
                        </div>
                    </div>
                    {/* end top */}
                    <div className="data">
                        <tdtd>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>${this.state.feePerHour}</td>
                                    <td>{this.state.hour}</td>
                                    <td>${this.state.feeTotal}</td>
                                </tr>
                                <tr>
                                    <td />
                                    <td />
                                ...
                                <tr>
                                    <td />
                                    <td />
                                    <td className="xanh">GRAND TOTAL</td>
                                    <td className="xanh">${this.state.feeTotal}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="termcondition">
                        <div className="col-md-7">
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptates dolore doloremque voluptatibus reprehenderit, in possimus ab illo quos mollitia delectus voluptatum tenetur nisi. Labore quidem, sint blanditiis suscipit deserunt repellendus!</p>
                        </div>
                    </div>
                    <div className="thank">
                        <p>thank for your donation</p>
                    </div>
                </div>
